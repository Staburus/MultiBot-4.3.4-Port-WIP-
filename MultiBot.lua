...
if(table.wipe == nil) then
	table.wipe = wipe or function(pTable)
		for tKey in pairs(pTable) do pTable[tKey] = nil end
		return pTable
	end
end

MultiBot.setSize = function(pFrame, pWidth, pHeight)
	local tHeight = pHeight
	if(tHeight == nil) then tHeight = pWidth end
	
	if(pFrame.SetSize ~= nil) then
		pFrame:SetSize(pWidth, tHeight)
	else
		pFrame:SetWidth(pWidth)
		pFrame:SetHeight(tHeight)
	end
end

MultiBot.setSize(MultiBot, 1, 1)
MultiBot:Show()
...
MultiBot.tips.quick = {}
MultiBot.tips.quick.master =
"Quick-Control\n|cffffffff"..
"A compact set of the most common bot commands.|r\n\n"..
"|cffff0000Left-Click to show or hide Quick-Control|r\n"..
"|cff999999(Execution-Order: System)|r";

MultiBot.tips.quick.bots =
"Bot List\n|cffffffff"..
"Shows or hides the bot roster so you can select a specific bot.|r\n\n"..
"|cffff0000Left-Click to show or hide bot list|r\n"..
"|cff999999(Execution-Order: System)|r";

MultiBot.tips.quick.follow =
"Follow\n|cffffffff"..
"Orders the group to follow you.|r\n\n"..
"|cffff0000Left-Click to follow|r\n"..
"|cff999999(Execution-Order: Raid, Party)|r";

MultiBot.tips.quick.stay =
"Stay\n|cffffffff"..
"Orders the group to stay at the current position.|r\n\n"..
"|cffff0000Left-Click to stay|r\n"..
"|cff999999(Execution-Order: Raid, Party)|r";

MultiBot.tips.quick.attack =
"Attack Target\n|cffffffff"..
"Orders the group to attack your current target.|r\n\n"..
"|cffff0000Left-Click to attack target|r\n"..
"|cff999999(Execution-Order: Raid, Party)|r";

MultiBot.tips.quick.tank =
"Tank Attack\n|cffffffff"..
"Orders tank bots to attack your current target.|r\n\n"..
"|cffff0000Left-Click for tank attack|r\n"..
"|cff999999(Execution-Order: Raid, Party)|r";

MultiBot.tips.quick.passive =
"Passive\n|cffffffff"..
"Toggles passive combat mode for the group.|r\n\n"..
"|cffff0000Left-Click to toggle passive|r\n"..
"|cff999999(Execution-Order: Raid, Party)|r";

MultiBot.tips.quick.flee =
"Flee\n|cffffffff"..
"Orders the group to flee.|r\n\n"..
"|cffff0000Left-Click to flee|r\n"..
"|cff999999(Execution-Order: Raid, Party)|r";

MultiBot.tips.quick.summon =
"Summon\n|cffffffff"..
"Summons the group to your position.|r\n\n"..
...
MultiBot.tips.main.advanced =
"Advanced-Bar\n|cffffffff"..
"Shows or hides the less-used combat controls to keep the toolbar compact.|r\n\n"..
